// ans.cpp 13 Nov 18, 23:02:57 30 3.99 Judging completed in 6.569s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
#pragma O3
...
ll powers[15]={1,10,100,1000,10000,100000,1000000,10000000,100000000,1000000000,10000000000,100000000000};
//powers of 10 for O(1) calculation
int main(){
	ios_base::sync_with_stdio(false);
	cin.tie(0);
	vector<int> start;
	queue<pair<ll,pair<int,int> > >bfs;
