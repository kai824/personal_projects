// ans.cpp 15 Feb 17, 20:29:13 0 0.03 Judging completed in 6.329s on AWS Ireland.
#include <bits/stdc++.h>
using namespace std;
struct connection{
...
int main() {
    ...
    for(int x=0;x<q;x++){
    	cin>>b>>c;
    	if(adjmatrix[b][c].first==INT_MAX*INT_MAX*2)cout<<-1<<endl;
