// ans.cpp 28 Dec 19, 14:04:56 39 0.21 Judging completed in 5.58s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
...
deque<pair<ll,multiset<ll> > > v;//level,complexities...
...
int main(){
	...
	sort(arr,arr+n);
	multiset<ll> ss;ss.insert(arr[0].second);
