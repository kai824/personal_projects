// ans.cpp 28 Dec 19, 14:03:34 16 0.21 Judging completed in 5.445s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
...
deque<pair<int,multiset<int> > > v;//level,complexities...
...
int main(){
	...
	sort(arr,arr+n);
	multiset<int> ss;ss.insert(arr[0].second);
