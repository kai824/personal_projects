// ans.cpp 8 Dec 17, 19:53:49 64 0.1 Judging completed in 3.969s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
...
ll calc(long long w,long long d){
	long long x=w-w%d,y,ans,z;//y is no. of elements*2
	y=x/d;
	if (w%d!=0){
		y++;
	}
