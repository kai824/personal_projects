// ans.cpp 12 Dec 17, 16:40:04 0 0.18 Judging completed in 3.553s on AWS Oregon.
#include <bits/stdc++.h>
using namespace std;
...
int main() {
    ...
    for(int x=1;x<=n;x++){
        ...
        if(a=="a"){
        	cin>>b;
        	b=getnode(b);//get the right node first...
        	parent[0][x]=b;
        	node[x]=x;
        	value[x]=x;
        	for(int y=1;y<20;y++){
