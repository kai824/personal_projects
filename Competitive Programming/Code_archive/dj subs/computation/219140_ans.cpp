// ans.cpp 19 Aug 17, 22:44:26 0 0 Judging completed in 2.832s on AWS Oregon.
#include <bits/stdc++.h>
using namespace std;
typedef long long ll;
ll n,arr[100000005],arr2[20];
ll process(ll x) {
    ll ct = 0;
    ll k = 1;
    while (k <= x) {
...
int main() {
    ...
    */
    for(int x=0;x<15;x++){cout<<long_computation(arr2[x])<<' ';}cout<<long_computation(arr2[15]);
    return 0;
}