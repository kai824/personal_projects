// ballgame.cpp 31 Jan 19, 19:57:03 0 1.22 Judging completed in 7.496s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
...
int ballgame(int n, int l, int d, int h[], int c[]) {
    ...
    for(ll x=1;x<n;x++){
        a=root->query(max(ppl[x].second-d,0),min(ppl[x].second+d,1000000001),0,1000000001);
