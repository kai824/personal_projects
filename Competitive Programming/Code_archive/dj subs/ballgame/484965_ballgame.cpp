// ballgame.cpp 31 Jan 19, 22:24:10 0 0.67 Judging completed in 4.058s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
...
int ballgame(int n, int l, int d, int h[], int c[]) {
    ...
    for(ll x=1;x<n;x++){
        a=query(max(lr[ppl[x].second].second.first,1LL),min(lr[ppl[x].second].second.second,dis));
