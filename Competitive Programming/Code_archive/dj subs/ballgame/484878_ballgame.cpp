// ballgame.cpp 31 Jan 19, 19:57:54 0 0.99 Judging completed in 4.586s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
...
int ballgame(int n, int l, int d, int h[], int c[]) {
    ...
    for(ll x=1;x<n;x++){
        a=root->query(max(ppl[x].second-d,(ll)0),min(ppl[x].second+d,(ll)1000000001),0,1000000001);
