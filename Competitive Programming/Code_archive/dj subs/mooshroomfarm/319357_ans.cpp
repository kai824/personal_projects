// ans.cpp 26 Jan 18, 22:26:48 11 1.12 Judging completed in 6.873s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
...
int main(){
	...
	for(ll x=0;x<q;x++){
		...
		if(a=="feed"){
			...
			cout<<min(f+sp_odd->query(1,1,R,C,b,c,d,e)+(c-g),(b-f)+g+sp_even->query(1,1,R,C,b,c,d,e))<<'\n';
		}
	}
	return 0;
}