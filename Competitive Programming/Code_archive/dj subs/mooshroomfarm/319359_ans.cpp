// ans.cpp 26 Jan 18, 22:36:18 11 1.06 Judging completed in 8.133s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
...
int main(){
	...
	for(ll x=0;x<q;x++){
		...
		if(a=="feed"){
			...
			if((k%2)==1)cout<<min(f+(c-g+sp_even->query(1,1,R,C,b,c,d,e)),(b-f+sp_odd->query(1,1,R,C,b,c,d,e))+g)<<'\n';
