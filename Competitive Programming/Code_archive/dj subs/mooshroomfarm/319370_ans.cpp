// ans.cpp 26 Jan 18, 23:01:16 100 1.21 Judging completed in 9.033s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
...
int main(){
	...
	for(ll x=0;x<q;x++){
		...
		if(a=="feed"){
			...
			if((k%2)==1)cout<<min(f+(c-g+(sp_even->query(1,1,R,C,bb,cc,dd,ee))),(b-f+(sp_odd->query(1,1,R,C,bb,cc,dd,ee)))+g)<<'\n';
