// ans.cpp 19 Nov 19, 10:26:50 100 0.17 Judging completed in 5.484s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
...
ll dia[100005][3];//store 2 ends of diameter...
...
int main(){
    ...
    for(int x=0;x<n-1;x++){
        ...
        if(dia[a][2]>dia[b][2]){
            swap(a,b);swap(n1,n2);
        }//ensure diameter of b greater than a
        merge(a,b);
        if(l>dia[b][2]){
    		dia[b][1]=dia[b][n2];
            dia[b][0]=dia[a][n1];
