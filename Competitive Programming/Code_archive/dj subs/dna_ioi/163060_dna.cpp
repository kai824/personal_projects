// dna.cpp 18 Nov 16, 19:27:53 11 0.52 Judging completed in 10.228s on AWS Ireland.
#include "dna.h"
#include <iostream>
#include <vector>
using namespace std;
            ...
            if(nm_back==false){
                if(test(i,(ans+"0"))) ans=ans+"0";
                    ...
                    if(nm_back2=false && test(i,(ans+"10"))){
                        i.push_back(ans+"0");
                        ans=ans+"10";
                    }else if(nm_back2==false && test(i,(ans+"110"))){
                        i.insert(i.end(),{(ans+"0"),(ans+"10")});
                        ans=ans+"110";
                    }else if(nm_back2==false && test(i,(ans+"1110"))){
                        i.insert(i.end(),{(ans+"0"),(ans+"10"),(ans+"110")});
                        ans=ans+"1110";
                    }else if(nm_back2==false && test(i,(ans+"11110"))){
                        i.insert(i.end(),{(ans+"0"),(ans+"10"),(ans+"110"),(ans+"1110")});
                        ans=ans+"11110";
                    }else if(nm_back2==false && test(i,(ans+"11111"))){
