// dna.cpp 18 Nov 16, 20:00:22 36 0.67 Judging completed in 6.008s on AWS Ireland.
#include "dna.h"
#include <iostream>
#include <vector>
using namespace std;
