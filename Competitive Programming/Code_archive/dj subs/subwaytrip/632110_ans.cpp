// ans.cpp 6 Dec 19, 18:00:28 100 0.68 Judging completed in 5.286s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
...
int dist[500005];
pair<int,int> arr[500005];//opposite of mp
//map<pair<int,int>,int> mp;
unordered_map<int,int> mp[100005];

//map pair(node,colour) to our node number...

vector<pair<int,bool> > adjlis[500005];//end, weight
