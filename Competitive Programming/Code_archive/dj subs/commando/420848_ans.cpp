// ans.cpp 24 Nov 18, 14:38:05 70 0.17 Judging completed in 2.235s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
typedef long long ll;
inline long double divide(ll a,ll b){
	long double aa=a,bb=b;
	return aa/bb;
}

//convex hull...
vector<pair<long double,pair<long double,ll> > >lines;
inline void add_line(long double m, ll c){//gradient, y-intercept, assumes increasing gradient
	while(lines.size()>=2){
