// ans.cpp 14 Jan 18, 21:41:23 50 1.19 Judging completed in 6.603s on AWS Oregon.
#include<bits/stdc++.h>
using namespace std;
...
void xupdate(ll row,ll s,ll e){
	...
	xnums[row]->update(s,1,1,1e9);
	xnums[row]->update(e+1,-1,1,1e9);
}
void yupdate(ll column,ll s,ll e){
	...
	ynums[column]->update(s,1,1,1e9);
	ynums[column]->update(e+1,-1,1,1e9);
}
