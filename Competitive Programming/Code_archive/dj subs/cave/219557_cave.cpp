// cave.cpp 26 Aug 17, 19:36:33 63 0.4 Judging completed in 7.238s on AWS Oregon.
#include "cave.h"
#include<bits/stdc++.h>
using namespace std;
bool used[5005];
...
void exploreCave(int n){
    int ans[n],attempt[n],c,a=-2,b,ans2[n];
    for(int x=0;x<n;x++){
