// ans.cpp 7 Feb 18, 20:14:44 76 2.26 Judging completed in 5.667s on AWS Oregon.
#include <bits/stdc++.h>
using namespace std;
...
int main() {
    ...
    sort(arr,arr+n,[](const pair<int,int>& a, const pair<int,int>& b)-> bool {return(a.first>b.first);});
