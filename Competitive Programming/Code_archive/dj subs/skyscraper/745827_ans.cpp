// ans.cpp 30 Jun 20, 09:36:52 57 1.22 Judging completed in 5.433s on AWS Oregon.
#include"bits/stdc++.h"
using namespace std;
...
vector<pair<pii,int> > adjl[30005][175];//position, power, weight... if power==0, then it's dummy
